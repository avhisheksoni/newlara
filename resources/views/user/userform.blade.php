...
@section('content')
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>User Create</h1>
          <p>User Form</p>
        </div>
            ...
            <div class="tile-body">
              <form class="form-horizontal">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="text" name="email" placeholder="Enter email address">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control col-md-8" name="password" type="text" placeholder="Enter ">
